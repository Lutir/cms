...
/* PAGE INHERITED INFO */
	...
	<a name="inheritinfoform"></a>
		<fieldset style="padding: 8px">
			...
			<form name="pagesettings" class="center text-center" action="./+settings&subaction=editinheritedinfo" method="POST">
				<table border="1">
					<tr>
...
/* PAGE MOVE COPY TEXT BEGINS */
	...
	$movecopyPageSettingsText =<<<MOVECOPY
	 ...
	 <fieldset>
      ...
      <form name="pagesettings" class="text-center" action="./+settings&subaction=move" onsubmit="return moveOnSubmit()" method="POST">
		<table border="1">
			<tr>
				<td valign="top">
    ...
    <form name="pagesettings" action="./+settings&subaction=pagesettings&pageName=" method="POST" onsubmit="return settingsOnSubmit();">
        ...
        <a name="pageinfoform"></a>
      	...
      	<fieldset>
	        ...
	        <table border="1" cellpadding="2px" cellspacing="2px" width="100%">
		...
		<legend class="text-center"> Menu Settings</legend>

		<table border="1" cellpadding="2px" cellspacing="2px" width="80%;">
